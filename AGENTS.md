...
- `external-review-and-reproduction-certificates-from-finite-capacity-causal-networks/`: Paper 16 skeleton for external review and reproduction certificates from the closed Paper 15 result. Key files: `README.md`, `UPSTREAM-PAPERS.json`, `docs/external_review_reproduction_certificates_theorem.md`, `GPD/formal/FiniteCapacity/ExternalReviewReproductionCertificates.lean`.
- `physical-promotion-attempt-from-finite-capacity-causal-networks/`: Paper 17 skeleton for physical promotion attempt records from the closed Paper 16 result. Key files: `README.md`, `UPSTREAM-PAPERS.json`, `docs/physical_promotion_attempt_theorem.md`, `GPD/formal/FiniteCapacity/PhysicalPromotionAttempt.lean`.
- `unified-field-theory-candidate-synthesis-from-finite-capacity-causal-networks/`: Paper 18 skeleton for unified field theory candidate synthesis records from the closed Paper 17 result. Key files: `README.md`, `UPSTREAM-PAPERS.json`, `docs/unified_field_theory_candidate_synthesis_theorem.md`, `GPD/formal/FiniteCapacity/UnifiedFieldTheoryCandidateSynthesis.lean`.
- `unified-field-theory-physical-promotion-dossier-from-finite-capacity-causal-networks/`: downstream physical-promotion dossier after the closed Paper 18 result. Key files: `README.md`, `UPSTREAM-PAPERS.json`, `docs/unified_field_theory_physical_promotion_dossier.md`, `GPD/formal/FiniteCapacity/UFTPhysicalPromotionDossier.lean`.
...
- `cd external-review-and-reproduction-certificates-from-finite-capacity-causal-networks && make test-fast`: Paper 16 guard checks.
- `cd external-review-and-reproduction-certificates-from-finite-capacity-causal-networks && make lean-build`: Paper 16 Lean scaffold verification.
- `cd physical-promotion-attempt-from-finite-capacity-causal-networks && make test-fast`: Paper 17 guard checks.
- `cd physical-promotion-attempt-from-finite-capacity-causal-networks && make lean-build`: Paper 17 Lean scaffold verification.
- `cd unified-field-theory-candidate-synthesis-from-finite-capacity-causal-networks && make test-fast`: Paper 18 guard checks.
- `cd unified-field-theory-candidate-synthesis-from-finite-capacity-causal-networks && make lean-build`: Paper 18 Lean scaffold verification.
- `cd unified-field-theory-physical-promotion-dossier-from-finite-capacity-causal-networks && make test-fast`: physical-promotion dossier guard checks.
- `cd unified-field-theory-physical-promotion-dossier-from-finite-capacity-causal-networks && make lean-build`: physical-promotion dossier Lean scaffold verification.
